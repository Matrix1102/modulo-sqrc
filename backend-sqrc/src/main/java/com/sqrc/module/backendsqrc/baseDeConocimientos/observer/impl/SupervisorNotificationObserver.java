 ...
 * 
 * <p>
 * Envía notificaciones a los supervisores cuando ocurren eventos
 * que requieren su atención, como versiones propuestas para revisión.
 * </p>
 * 
 * <p>
...
public class SupervisorNotificationObserver implements IArticuloObserver {
    ...
    private void notificarVersionPropuesta(ArticuloEvent evento) {
        ...
        // "El artículo " + evento.getCodigoArticulo() + " tiene una nueva versión para
        // revisar"
        // );
    }
    ...
    private void notificarVersionRechazada(ArticuloEvent evento) {
        ...
        log.warn("  → Motivo: {}",
                evento.getDatosAdicionales() != null ? evento.getDatosAdicionales() : "Sin motivo especificado");
