 ...
 * 
 * <p>Define el contrato para la creación de artículos y sus versiones,
 * permitiendo encapsular la lógica de construcción y facilitar la extensibilidad.</p>
 * 
 * <p><b>Patrones utilizados:</b></p>
 * <ul>
 *   <li><b>Factory Method:</b> Métodos para crear diferentes tipos de artículos según el origen</li>
 *   <li><b>Abstract Factory:</b> Combinación de creación de Articulo y ArticuloVersion</li>
 * </ul>
 * 
...
public interface ArticuloFactory {
    ...
    /**
     * Crea un artículo completo (artículo + versión inicial) usando el contexto proporcionado.
     * 
