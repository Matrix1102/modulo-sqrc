...
/**
 * Specification Pattern - Builder fluido para construir especificaciones de artículos.
 * 
 * <p>Permite construir especificaciones complejas de forma legible y fluida,
 * especialmente útil para convertir DTOs de búsqueda en especificaciones.</p>
 * 
...
public class ArticuloSpecificationBuilder {
     ...
     */
    public ArticuloSpecificationBuilder conEtiqueta(com.sqrc.module.backendsqrc.baseDeConocimientos.model.Etiqueta etiqueta) {
        if (etiqueta != null) {
     ...
     */
    public ArticuloSpecificationBuilder conVisibilidad(com.sqrc.module.backendsqrc.baseDeConocimientos.model.Visibilidad visibilidad) {
        if (visibilidad != null) {
     ...
     */
    public ArticuloSpecificationBuilder paraTipoCaso(com.sqrc.module.backendsqrc.baseDeConocimientos.model.TipoCaso tipoCaso) {
        if (tipoCaso != null) {
