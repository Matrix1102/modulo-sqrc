...
public class DocumentacionController {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<DocumentacionDto> obtenerDocumentacionPorId(@PathVariable Integer id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> eliminarDocumentacion(@PathVariable Integer id) {
