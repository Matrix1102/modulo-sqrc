...
interface GenerarDesdeDocumentacionModalProps {
  isOpen: boolean;
  onClose: () => void;
  idCreador: number;
...
const GenerarDesdeDocumentacionModal: React.FC<GenerarDesdeDocumentacionModalProps> = ({
  ...
  const handleKeyDown = (e: React.KeyboardEvent) => {
    if (e.key === "Enter" && !loading && idDocumentacion) {
      handleGenerar();
    }
  };
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <div className="flex gap-3">
              ...
              <p className="text-sm text-blue-700">
                Ingresa el ID de documentación de un ticket y la IA generará
                automáticamente el artículo con título, contenido y categoría.
              </p>
            </div>
          </div>
...
export default GenerarDesdeDocumentacionModal;
